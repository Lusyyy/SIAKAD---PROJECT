...
<div class="container">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0">Jadwal Akademik Golongan {{ $golongan->nama_Gol }}</h4>
            <div>
                <a href="{{ route('jadwal.create') }}" class="btn btn-primary btn-sm">
                    <i class="bi bi-plus"></i> Tambah Jadwal
                </a>
                <a href="{{ route('jadwal.pdf', ['golongan' => $golongan->id_Gol]) }}" class="btn btn-danger btn-sm" target="_blank">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="text-center">Tidak ada jadwal untuk golongan {{ $golongan->nama_Gol }}</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
